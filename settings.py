...
#specify start and endtimes of previous season
prevseasonstart = datetime(2019, 3, 24)
prevseasonend = datetime(2019, 9, 22)

#Player class
class Player:
    def __init__(self, id, name, state, mains=None, curPRs=None):
...
Arcade = Player('58cc88171d41c8259fa1fc21', 'Arcade', 'MA', 'Captain Falcon',
                {'UMA': 3})
Artelind = Player('58d20b761d41c8259fa1ff7b', 'Artelind', 'RI', 'Samus', 
                  {'RI': 3})
...
BigRedAnimeBike = Player('58752d371d41c82e80d558a3', 'BigRedAnimeBike', 'MA', 
                         ['Fox', 'Sheik'])
...
Guillotine = Player('5d295939421aa90f9fc1bd97', 'Guillotine', 'NH', 'Sheik',
                    {'NH': 7})
...
Joyboy = Player('58c73c7e1d41c8259fa1f9c5', 'Joyboy', 'RI', 'Fox', 
                {'RI': 1, 'NE': 3})
Kalvar = Player('58c726dd1d41c8259fa1f870', 'Kalvar', 'NH', 'Marth', 
                {'NH': 1, 'NE': 2})
Kikoho = Player('5b40def21d41c8456a883413', 'Kikoho', 'CT', 'Marth', 
                {'CT': 6, 'NE': 12})
Klaps = Player('58cc6fc61d41c8259fa1fb57', 'Klaps', 'MA', 'Captain Falcon', 
               {'MA': 6})
Kota = Player('58cc6fc61d41c8259fa1fb6a', 'Kota', 'MA', 'Falco')
Lint = Player('545c8e5f8ab65f12c01061ca', 'lint', 'CT', 'Falco', 
              {'CT': 2, 'NE': 5})
Lochist = Player('5c86c4d1421aa93db94e9ab6', 'Lochist', 'VT', 
...
Palika = Player('58cc88171d41c8259fa1fc20', 'Palika', 'CT', 'Dr. Mario',
                {'CT': 4, 'NE': 7})
Peacecraft = Player('587c636d1d41c82e80d55aaf', 'M. Peacecraft', 'CT', 
                    ['Marth', 'Fox', 'Sheik'])
PJ = Player('542cf4d08ab65f5e0c6e0751', 'PJ', 'MA', 'Falco', {'MA': 9})
Poonpounder = Player('5e2fcf55421aa93e12ba4946', 'Poonpounder', 'MA', 'Fox', 
                     {'BU': 2})
Project = Player('58cc748e1d41c8259fa1fbb8', 'Project', 'MA', 'Fox', 
                 {'MA': 1, 'NE': 9})
PSai = Player('5d82976f421aa954d874af04', 'PSai', 'MA', 'Sheik', {'BU': 1})
Ricky = Player('58cc88171d41c8259fa1fc23', 'Ricky', 'CT', 'Fox')
RyuCloud = Player('58c739fa1d41c8259fa1f97f', 'RyuCloud', 'RI', 
                  ['Marth', 'Fox'], {'RI': 5})
...
Shmeeli = Player('58811d861d41c82e80d55b56', 'Shmeeli', 'MA', 'Falco', 
                 {'NEU': 2})
Silver = Player('58c7303b1d41c8259fa1f8dc', 'Silver', 'MA', ['Falco', 'Fox'], 
                {'UMA': 1})
Slox = Player('542ded228ab65f7d9c8294d1', 'Slox', 'CT', 'Fox', 
              {'CT': 1, 'NE': 1})
Spiff = Player('58c7321f1d41c8259fa1f8fe', 'Spiff', 'MA', 'Sheik')
StacysStepdad = Player('5a4ba1961d41c84881946783', 'Stacy\'s Stepdad', 'ME', 
                       'Peach')
...
Thumbs = Player('58d082921d41c8259fa1fe0a', 'Thumbs', 'CT', 'Falco', 
                {'CT': 3, 'NE': 6})
Tian = Player('545b23eb8ab65f7a95f74924', 'Tian', 'MA', 'Sheik', {'MA': 8})
TimTheGuy = Player('58d333ed1d41c8259fa2001f', 'TimTheGuy', 'CT', 'Marth', 
                   {'CT': 7})
Trail = Player('5a93cebe1d41c80e2802a7fa', 'Trail', 'MA', 
               ['Ice Climbers', 'Ganondorf'], {'MA': 7})
...
Warmmer = Player('58f8246c1d41c850b8b0fa54', 'Warmmer', 'CT', 'Falco', 
                 {'CT': 5, 'NE': 8})
Woodcutting = Player('5b75ec7e421aa91fa088b1ef', '99 Woodcutting', 'MA', 
                     'Sheik', {'NEU': 1})
Yasu = Player('5a4ba0ba1d41c8488194677a', 'Yasu', 'MA', 'Marth', {'MA': 3})
Younger = Player('54af8e44d2994e1346cd31da', 'Younger', 'MA', 'Falco', 
                 {'MA': 'HM'})
