...
for player in players:
    ...
    if player.curPRs is not None:

        if ('CT' in player.curPRs.keys() or 'MA' in player.curPRs.keys() or 'RI'
                in player.curPRs.keys() or 'NH' in player.curPRs.keys() or 'VT' in
                player.curPRs.keys()):
            ...
            if (1 in player.curPRs.values() or 2 in player.curPRs.values() or 3
                ...
                for opponent in players:
                    ...
                    if opponent.curPRs is not None:

                        if ('NE' in opponent.curPRs.keys() or 'CT' in opponent.curPRs.keys() or 'MA'
                                in opponent.curPRs.keys() or 'RI' in opponent.curPRs.keys() or 'NH' in
                                opponent.curPRs.keys() or 'VT' in opponent.curPRs.keys()):
