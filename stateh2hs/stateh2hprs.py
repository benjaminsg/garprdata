...
for player in players:
    ...
    if(player.curPRs != None):
    
        if('NE' in player.curPRs.keys() or 'CT' in player.curPRs.keys() or 'MA' 
           in player.curPRs.keys() or 'RI' in player.curPRs.keys() or 'NH' in 
           player.curPRs.keys() or 'VT' in player.curPRs.keys()):
